...
The YouTubeChat Excel workbook takes the youtube live chat json file generated by yt-dlp, repairs it and renders a subset of the available fields. I have not found any documentation for the json schema and yt-dlp uses a different live chat schema in different scenarios.  I have done my best to account for the different schemas but there may be errors.  If you find a problem you can log a bug or feature request.  Bug reports must include the JSON file that was generated by YT-DLP. 
